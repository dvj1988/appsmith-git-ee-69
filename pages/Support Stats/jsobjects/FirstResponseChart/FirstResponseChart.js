export default {
	...
	getEnterpriseMediumChart(bg, c) {
		const data = Utils.getEnterpriseIssues(Utils.getMediumIssues(get_first_response_time.data));
		return TimingChart.getTimingChart(data, bg, c);
	},
	getEnterpriseNormalChart(bg, c) {
		const data = Utils.getEnterpriseIssues(Utils.getNormalIssues(get_first_response_time.data));
		return TimingChart.getTimingChart(data, bg, c);
	},
	getEnterpriseLowChart(bg, c) {
		const data = Utils.getEnterpriseIssues(Utils.getLowIssues(get_first_response_time.data));
		return TimingChart.getTimingChart(data, bg, c);
	},
	...
	getCommonMediumChart(bg, c) {
		const data = Utils.getMediumIssues(get_first_response_time.data);
		return TimingChart.getTimingChart(data, bg, c);
	},
	getCommonNormalChart(bg, c) {
		const data = Utils.getNormalIssues(get_first_response_time.data);
		return TimingChart.getTimingChart(data, bg, c);
	},
	getCommonLowChart(bg, c) {
		const data = Utils.getLowIssues(get_first_response_time.data);
		return TimingChart.getTimingChart(data, bg, c);
	},
}